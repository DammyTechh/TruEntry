...
const definition = {
  ...
  tags: [
    ...
    { name: 'Admissions', description: 'Ranked admission processing, decisions and cycle closure' },
    { name: 'JAMB Audit', description: 'Regulatory audit reporting and PDF/Excel export' },
    { name: 'Institution Workspace', description: 'Faculties, departments and organisation settings' },
    { name: 'Quotas', description: "Admission cycles: allocation, O'Level requirements, department distribution, eligibility" },
